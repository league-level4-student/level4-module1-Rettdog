...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Use the arrows keys to move and collect food";
...
timer.start();
	...
	private void setFoodLocation() {
		...
		Location loc = new Location(randy.nextInt(15),randy.nextInt(12));
...
String string = JOptionPane.showInputDialog("Would you like to play again");
